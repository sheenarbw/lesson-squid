...
This project is all about teaching people to code. The basic aims are:
- work offline: a lot of people dont have reliable internet connections. We dont want to exclude anyone
- be unintimidating: Even seasoned developers are often overwhelmed by choices. Instead of listing a bunch of technologies, we want to list a bunch of end goals and then guide the user to achieve those goals using technologies we have chosen
- be usable on an android smartphone. The lessons need to work on a little screen
